        ...
        <tr v-for="pokemon of this.pokemon" :key="pokemon">
          ...
          <td>
            <div class="d-flex justify-content-evenly">
              <button class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#editModal" v-on:click="editForm(pokemon.trained_pokemon_id)">
                <i class="bi bi-pencil-fill"> Edit</i>
              </button>
              <button class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" v-on:click="editForm(pokemon.trained_pokemon_id)">
